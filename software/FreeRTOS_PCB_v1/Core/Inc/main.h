...
#define XSHUT4_Pin GPIO_PIN_0
#define XSHUT4_GPIO_Port GPIOB
#define INT4_Pin GPIO_PIN_1
#define INT4_GPIO_Port GPIOB
#define INT4_EXTI_IRQn EXTI1_IRQn
#define XSHUT0_Pin GPIO_PIN_2
#define XSHUT0_GPIO_Port GPIOB
#define INT0_Pin GPIO_PIN_10
#define INT0_GPIO_Port GPIOB
#define XSHUT5_Pin GPIO_PIN_11
#define XSHUT5_GPIO_Port GPIOB
#define INT5_Pin GPIO_PIN_12
