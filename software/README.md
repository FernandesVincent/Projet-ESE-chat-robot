...
Ce programme TOF n'est pas celui utilisé dans le code rassemblé pour la démonstration, mais je trouve qu'il est bien parce que les tof sont configuré pour envoyé une interruption sur dépassement de seuil, on n'a donc pas à faire la comparaison de la distance à chaque réception d'interruption.
